...
| 工具 | 提供方 | 说明 |
|------|--------|------|
| MCP `mcp_sciverse`（含5个子工具） | OpenDataLab | 学术论文语义搜索引擎，中英文双语，4.65亿记录 | https://sciverse.opendatalab.com/ |
...
| Sciverse | OpenDataLab | 中英文学术论文语义搜索+段落级引用佐证 | https://sciverse.opendatalab.com/ |
